.. _appendix-q-references:

References
============


.. _related-information_references:
...
-  `Compute Express Link (CXL) Specification: see download link at <https://uefi.org/uefi>__` *https://uefi.org/uefi#cxl-specification* .
...
.. _prerequisite-specifications_references:
...
.. _acpi-specification_references:
...
.. _additional-considerations-for-itanium-based-platforms_references:

Additional Considerations for Itanium-BasedPlatforms
####################################################
